...
//			double maxOf4 = Math.max( Math.max( p1.percentLessThan, p1.percentMoreThan ), Math.max( p2.percentLessThan, p2.percentMoreThan ) ); 
//			if ( (p1.percentLessThan == maxOf4) || (p2.percentMoreThan ==  maxOf4) )
//				return 1;			}
//			else
//				return -1;
